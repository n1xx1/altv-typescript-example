...
// Generated on "9/11/2019, 7:41:48 PM"
...
declare module "alt" {
  ...
  export class MemoryBuffer {
    ...
    constructor(p0: number);
    byte(offset: number|number, p1: number): undefined|null|number|BigInt|number|string;
    double(offset: number|number, p1: number): undefined|null|number|BigInt|number|string;
    float(offset: number|number, p1: number): undefined|null|number|BigInt|number|string;
    free(): boolean;
    int(offset: number|number, p1: number): undefined|null|number|BigInt|number|string;
    long(offset: number|number, p1: number): undefined|null|number|BigInt|number|string;
    short(offset: number|number, p1: number): undefined|null|number|BigInt|number|string;
    string(offset: number|number, p1: number): undefined|null|number|BigInt|number|string;
    ubyte(offset: number|number, p1: number): undefined|null|number|BigInt|number|string;
    uint(offset: number|number, p1: number): undefined|null|number|BigInt|number|string;
    ulong(offset: number|number, p1: number): undefined|null|number|BigInt|number|string;
    ushort(offset: number|number, p1: number): undefined|null|number|BigInt|number|string;
  }
  ...
  export function getDiscordOAuth2Result(): Object|undefined|null;
